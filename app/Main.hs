...
drawScore gs =
  let p1 = p1Score gs
      p2 = p2Score gs
   in pictures
        [ translate (-200, 120) $ scale 0.7 0.7 $ Color white $ Text (show p1),
